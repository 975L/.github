...
| <img src="images/CrowdfundingBundle.svg" alt="" width="80"> | [CrowdfundingBundle](https://github.com/975L/CrowdfundingBundle) <br> `c975l/crowdfunding-bundle` — *not on Packagist yet, install from source* | Crowdfunding campaigns — counterparts, contributors, news and media — plus a lottery, checking out through PaymentBundle | Config, Ui, Payment |
